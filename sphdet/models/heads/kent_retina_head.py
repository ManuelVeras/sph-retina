...
class KentRetinaHead(RetinaHead):
    def __init__(self, box_version=5, *args, **kwargs):
        assert box_version in [4, 5]
        self.box_version = box_version
        #pdb.set_trace()
        super(KentRetinaHead, self).__init__(*args, **kwargs)

    def _init_layers(self):
        super(KentRetinaHead, self)._init_layers()
