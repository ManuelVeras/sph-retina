...
def ensure_single_list_bbox(annotations):
...
def main(image_limit, object_limit):
    ...
    single_list_annotations = ensure_single_list_bbox(filtered_annotations)

    # Update the JSON data with filtered images and annotations
    json_data['images'] = filtered_images
    json_data['annotations'] = single_list_annotations
